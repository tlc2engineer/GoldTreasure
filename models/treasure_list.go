...
// ContextValidate validate this treasure list based on the context it is used
func (m TreasureList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
